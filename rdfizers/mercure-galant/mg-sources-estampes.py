...
def process(data):
    ...
    t(estampe_id_iiif, RDFS.label, u(f"http://data-iremus.huma-num.fr/iiif/3/mg_estampes--{id.replace(' ', '%20')}.tif/full/max/0/default.jpg"))
    ...
    if data["[Inventeur] ('Invenit' ou 'Pinxit' ou 'Delineavit') vs. 'fecit'"]:
        ...
        t(estampe_invenit_auteur, RDFS.label, l(data["[Inventeur] ('Invenit' ou 'Pinxit' ou 'Delineavit') vs. 'fecit'"]))
        ...
        if data["Technique de la représentation [Avec Maj et au pl.]"]:
            ...
            t(estampe_E29, RDFS.label, l(data["Technique de la représentation [Avec Maj et au pl.]"]))
    ...
    if data["[Graveur] 'Sculpsit' ou 'Incidit' vs. 'fecit'"]:
        ...
        t(estampe_sculpsit_auteur, RDFS.label, l(data["[Graveur] 'Sculpsit' ou 'Incidit' vs. 'fecit'"]))
        ...
        if data["Technique de la gravure [Avec Maj et au pl.]"]:
            ...
            t(estampe_E55, RDFS.label, l(data["Technique de la gravure [Avec Maj et au pl.]"]))
    ...
    if data["Provenance cliché"]:
        ...
        t(estampe_id_BnF, RDFS.label, l(data["Provenance cliché"]))
    ...
    if data["Cote article lié OBVIL"]:
        ...
        try:
            ...
            if data["Commentaire Cote article lié OBVIL"]:
                ...
                t(estampe_seeAlso_P3_E13, crm("P141_assigned"), l(data["Commentaire Cote article lié OBVIL"]))
    ...
    if data["Titre sur l'image"]:
        ...
        t(estampe_titre, crm("P141_assigned"), l(data["Titre sur l'image"]))
    ...
    if data["[titre descriptif forgé]* (Avec Maj - accentuées]"]:
        ...
        t(estampe_titre, crm("P14_carried_out_by"), she("684b4c1a-be76-474c-810e-0f5984b47921"))
        t(estampe_titre, crm("P140_assigned_attribute_to"), estampe)
        t(estampe_titre, crm("P141_assigned"), l(data["[titre descriptif forgé]* (Avec Maj - accentuées]"]))
    ...
    if data["[Titre dans le péritexte: Avis, article…]"]:
        ...
        t(estampe_titre, crm("P14_carried_out_by"), she("684b4c1a-be76-474c-810e-0f5984b47921"))
        t(estampe_titre, crm("P140_assigned_attribute_to"), estampe)
        t(estampe_titre, crm("P141_assigned"), l(data["[Titre dans le péritexte: Avis, article…]"]))
    ...
    if data["Lieux"]:
        ...
        try:
            ...
            if lieu_uuid:
                estampe_lieu_E13 = she(cache.get_uuid(["estampes", id, "E36", lieu, "zone de l'image (E36)", "lieu représenté"], True))
    ...
    if data["objet [en bdc, sg par défaut] / Personne représentés [avec Maj.]"]:
        ...
        for sujet in sujets:
            ...
            try:
                ...
                ### Recherche d'UUID dans le vocabulaire d'indexation des estampes
                try:
                    ...
                    if objet_uuid:
                        ...
                        if sujet == "médaille":
                            ...
                            estampe_zone_médaille = she(
                                cache.get_uuid(["estampes", id, "E36", sujet, "zone de l'image (E36)", "zone de la médaille (E36)", "uuid"], True))
                            t(estampe_zone_médaille, a, crm("E36_Visual_Item"))
                            estampe_zone_médaille_E13 = she(
                                cache.get_uuid(["estampes", id, "E36", sujet, "zone de l'image (E36)", "zone de la médaille (E36)", "E13 zone"], True))
                            ...
                            # La zone d'image contient une médaille
                            estampe_médaille_E13 = she(cache.get_uuid(
                                ["collection", id, "E36", sujet, "zone de l'image (E36)", "zone de la médaille (E36)", "E13 représentation"], True))
                            ...
                            if data["Médailles: légende"] or data["Médailles: exergue"]:
                                ...
                                médaille_inscrip_E36 = she(cache.get_uuid(["collection", id, "E36", sujet, "zone de l'image (E36)", "zone de la médaille (E36)", "zone d'inscription", "uuid"], True))
                                t(médaille_inscrip_E36, a, crm("E36_Visual_Item"))
                                # Ce que représente la zone d'inscription
                                médaille_inscrip_E13 = she(cache.get_uuid(["collection", id, "E36", sujet, "zone de l'image (E36)", "zone de la médaille (E36)", "zone d'inscription", "E13"], True))
                            ...
                            if data["Médailles: légende"]:
                                médaille_inscrip_E33 = she(
                                    cache.get_uuid(
                                        ["collection", id, "E36", sujet, "zone de l'image (E36)", "zone de la médaille (E36)", "zone d'inscription",
                                ...
                                t(estampe_médaille_inscrip_P190_E13, crm("P141_assigned"), l(data["Médailles: légende"]))
                            ...
                            if data["Médailles: exergue"]:
                                ...
                                t(estampe_médaille_inscrip_P190_E13, crm("P140_assigned_attribute_to"),
                                  médaille_inscrip_E33)
                                t(estampe_médaille_inscrip_P190_E13, crm("P141_assigned"), l(data["Médailles: exergue"]))
                                t(estampe_médaille_inscrip_P190_E13, crm("P177_assigned_property_type"),
                                  crm("P190_has_symbolic_content"))

                except:
                    estampe_objet_E13 = she(cache.get_uuid(["collection", id, "E36", sujet, "zone de l'image (E36)", "objet représenté"], True))
                    t(estampe_objet_E13, a, crm("E13_Attribute_Assignement"))
    ...
    if data["Type / Thématique [Avec Maj et au pl.]"]:
        ...
        for type_thématique in type_thématiques:
            ...
            try:
                ...
                t(estampe_thématique_E13, crm("P177_assigned_property_type"), she("f2d9b792-2cfd-4265-a2c5-e0a69ce01536"))
    ...
    if data["PROVENANCE"]:
        ...
        t(estampe_notes_E13, crm("P141_assigned"), l(data["PROVENANCE"]))
