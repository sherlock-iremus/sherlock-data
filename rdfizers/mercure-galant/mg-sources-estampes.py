...
def process(data):
	...
	if data["[Inventeur] ('Invenit' ou 'Pinxit' ou 'Delineavit') vs. 'fecit'"] or data[
	...
	if data["[Inventeur] ('Invenit' ou 'Pinxit' ou 'Delineavit') vs. 'fecit'"]:
		...
		t(estampe_invenit_auteur, RDFS.label,
		  l(data["[Inventeur] ('Invenit' ou 'Pinxit' ou 'Delineavit') vs. 'fecit'"]))
	...
	if data["Type / Thématique [Avec Maj et au pl.]"]:
		...
		for type_thématique in type_thématiques:
			...
			try:
				...
				print("La thématique ou technique", type_thématique.lower(),
