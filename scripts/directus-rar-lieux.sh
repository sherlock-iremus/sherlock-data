python3 ./directus/referentiels-ancien-regime/directus-lieux.py \
    ...
    --json_lieux_relations "./temp/referentiels-ancien-regime/directus/lieux/lieux-relations.json" \
    --json_indexations "./temp/referentiels-ancien-regime/directus/lieux/lieux-indexations.json"